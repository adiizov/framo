...
const Contact = () => {
    return (
        <Container>
            <div className="flex flex-col 2xl:flex-row py-[50px] xl:py-[100px] px-[30px] md:px-[80px] lg:px-[100px] xl:px-[180px]  bg-block-accent rounded-3xl 2xl:rounded-[60px] justify-between gap-x-[10%]">
